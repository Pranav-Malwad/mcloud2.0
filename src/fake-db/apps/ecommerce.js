  ...
  orderData: [
    {
      ...
      date: '5/16/2022',
      time: '2:11 AM',
      // NEWLY ADDED FIELDS QUOTES GRID STARTS HERE 
      accountExecutive: 'Justin Howard',
      nextFollowUpDate: '2024-10-01T00:00:00Z',
      stage: 'Quote',
      itar: 'Yes',
      leadType: 'New',
      account: 'Acme Corp Account',
      ...
      shippingCost: 500,
      projectAmount: 27000,
      supplierNetTerms: 'NET 30',
      shippingAccount: 'FedEx1234',
      gpPercentage: 10,
      ...
      firstName: 'Jane',
      lastName: 'Smith',
      // NEWLY ADDED FIELDS QUOTES GRID ENDS HERE 


      // NEWLY ADDED FIELDS ORDERS GRID STARTS HERE 
      customerPo: 'PO12345',
      ...
      woAudit: 'Completed',
      poAudit: 'Pending',
      invoicingStage: 'Finalized',
      actualShipDate: '2024-09-29T00:00:00Z',
      customerShip: 'UPS',
      supplierShip: 'DHL',
      commissionsAmount: 1250,
      // NEWLY ADDED FIELDS ORDERS GRID ENDS HERE 

      // NEWLY ADDED FIELDS FOR CASES 
    ...
    relatedTo: 'Product XYZ',
    subject: 'Unable to access the product',
    description: 'Customer is unable to access their product due to a login issue.',
    internalComments: 'Follow up with the customer in 2 days if no response.',
    webEmail: 'support@example.com',
    webPhone: '123-456-7890',
    createdDate: '2024-10-01T09:00:00Z',
    updatedDate: '2024-10-01T12:00:00Z',
    createdBy: 'admin',
    updatedBy: 'admin',
      // NEWLY ADDED FIELDS FOR CASES 
      methodNumber: 6522
    ...
    woAudit: 'Pending',
    poAudit: 'Completed',
    invoicingStage: 'In Progress',
    actualShipDate: '2024-10-11T00:00:00Z',
    customerShip: 'FedEx',
    supplierShip: 'UPS',
    commissionsAmount: 2100, 
      // ORDERS FIELDS 


      // NEWLY ADDED FIELDS FOR CASES
      caseOwner: 'John Smith',
      ...
      description: 'Customer has questions regarding the latest billing statement.',
      internalComments: 'Escalated to billing department.',
      webEmail: 'billing@example.com',
      webPhone: '987-654-3210',
      createdDate: '2024-10-02T10:00:00Z',
      updatedDate: '2024-10-02T11:30:00Z',
      createdBy: 'admin',
      updatedBy: 'user1',
      // NEWLY ADDED FIELDS FOR CASES
      methodNumber: 7538
    },
    {
      ...
      poAudit: 'Pending',
      invoicingStage: 'Finalized',
      actualShipDate: '2024-09-30T00:00:00Z',
      customerShip: 'DHL',
      supplierShip: 'FedEx',
      commissionsAmount: 1950 ,
      // ORDERS FIELDS 

      // NEWLY ADDED FIELDS FOR CASES
      caseOwner: 'Sarah Wilson',
      contactName: 'Liam Thompson',
      caseOrigin: 'Web',
      priority: 'Low',
      type: 'Feedback',
      reason: 'Product Suggestion',
      relatedTo: 'Product ABC',
      subject: 'Suggestion for improvement',
      description: 'Customer suggested adding new features to Product ABC.',
      internalComments: 'Consider for next product update.',
      webEmail: 'feedback@example.com',
      webPhone: '456-789-1230',
      createdDate: '2024-10-03T09:30:00Z',
      updatedDate: '2024-10-03T12:00:00Z',
      createdBy: 'user2',
      updatedBy: 'user3',
      // NEWLY ADDED FIELDS FOR CASES
      methodNumber: 5170
    },
    {
      ...
      poAudit: 'In Progress',
      invoicingStage: 'In Progress',
      actualShipDate: '2024-10-14T00:00:00Z',
      customerShip: 'UPS',
      supplierShip: 'FedEx',
      commissionsAmount: 1900, 
      // ORDER FIELDS 


      // NEWLY ADDED FIELDS FOR CASES 
      caseOwner: 'Michael Brown',
      contactName: 'Olivia White',
      caseOrigin: 'Chat',
      priority: 'High',
      type: 'Support',
      reason: 'Login Issue',
      ...
      description: 'Customer is experiencing issues logging into their account.',
      internalComments: 'Investigate login issues.',
      webEmail: 'support@website.com',
      webPhone: '321-654-0987',
      createdDate: '2024-10-04T08:15:00Z',
      updatedDate: '2024-10-04T10:00:00Z',
      createdBy: 'user4',
      updatedBy: 'user4',
      // NEWLY ADDED FIELDS FOR CASES 
      methodNumber: 1748
    },
    {
      ...
      poAudit: 'Completed',
      invoicingStage: 'Finalized',
      actualShipDate: '2024-09-25T00:00:00Z',
      customerShip: 'FedEx',
      supplierShip: 'DHL',
      commissionsAmount: 2200, 
      // ORDER FIELDS 


      // NEWLY ADDED FIELDS FOR CASES 
      caseOwner: 'Emily Davis',
    contactName: 'Jacob Martin',
    caseOrigin: 'Social Media',
    priority: 'Critical',
    type: 'Complaint',
    reason: 'Service Issue',
    relatedTo: 'Customer Service',
    subject: 'Unsatisfactory service experience',
    description: 'Customer is unhappy with the service received.',
    internalComments: 'Immediate response required.',
    webEmail: 'service@socialmedia.com',
    webPhone: '555-123-4567',
    createdDate: '2024-10-05T14:45:00Z',
    updatedDate: '2024-10-05T15:30:00Z',
    createdBy: 'user5',
    updatedBy: 'admin',
      // NEWLY ADDED FIELDS FOR CASES 
      methodNumber: 6425
    },
    {
      ...
      time: '6:12 PM',
      // NEWLY ADDED FIELDS 
      accountExecutive: 'Lorena Acosta',
      nextFollowUpDate: '2024-10-01T00:00:00Z',
      stage: 'Quote',
      itar: "Yes",
      leadType: 'Existing',
      ...
      shippingAccount: 'FedEx1234',
      gpPercentage: 10,
      projectManager: 'Lindsey Tundidor',
      industry: 'Energy',
      leadSource: 'Twitter',
      email: 'jane.smith@acmecorp.com',
      phone: '(555) 123-4567',
      ...
      poAudit: 'Completed',
      invoicingStage: 'In Progress',
      actualShipDate: '2024-10-01T00:00:00Z',
      customerShip: 'UPS',
      supplierShip: 'FedEx',
      commissionsAmount: 1350,
      // ORDER FIELDS 
    ...
    },
    {
      ...
      poAudit: 'In Progress',
      invoicingStage: 'Finalized',
      actualShipDate: '2024-10-18T00:00:00Z',
      customerShip: 'DHL',
      supplierShip: 'UPS',
      commissionsAmount: 1650,
      // ORDER FIELDS 
    ...
    },
    {
      ...
      poAudit: 'Pending',
      invoicingStage: 'In Progress',
      actualShipDate: '2024-09-22T00:00:00Z',
      customerShip: 'FedEx',
      supplierShip: 'DHL',
      commissionsAmount: 1750,
      // ORDER FIELDS 

      // NEWLY ADDED FIEDS FOR CASES 
      caseOwner: 'Michael Brown',
      contactName: 'Olivia White',
      caseOrigin: 'Chat',
      priority: 'High',
    ...
    },
    {
      ...
      poAudit: 'In Progress',
      invoicingStage: 'Finalized',
      actualShipDate: '2024-10-05T00:00:00Z',
      customerShip: 'DHL',
      supplierShip: 'UPS',
      commissionsAmount: 2000,
      // ORDER FIELDS
    ...
    },
    {
      ...
      poAudit: 'Completed',
      invoicingStage: 'Finalized',
      actualShipDate: '2024-11-01T00:00:00Z',
      customerShip: 'UPS',
      supplierShip: 'FedEx',
      commissionsAmount: 1800,
      // ORDER FIELDS 
  ...
  customerData: [
    {
      ...
      state: 'CA',
      owner: 'Jane Doe',
      accountRevenueYTD: 500000,
      accountRevenueLifetime: 2000000,
      upsAccount: 'UPS123456',
      fedexAccount: 'FEDEX123456',
      creditLimit: 100000,
      notes: 'Client requires regular updates on order status.',
      // ACCOUNTS FIELDS GRID 
    },
    {
      id: 2,
      ...
      // ACCOUNTS GRID FIELLDS 
      city: 'San Francisco',
      state: 'CA',
      owner: 'John Smith',
      accountRevenueYTD: 750000,
      accountRevenueLifetime: 3000000,
      upsAccount: 'UPS654321',
      fedexAccount: 'FEDEX654321',
      creditLimit: 150000,
    ...
    },
    {
      ...
      firstName: 'Alice',
      lastName: 'Johnson',
      account: 'Green Energy',
      email: 'alice.johnson@greenenergy.com',
      phone: '(555) 555-0123',
      accountExecutive: 'Garry Adams',
      projectManager: 'Dymond Mccoy',
      industry: 'Energy',
      leadSource: 'Social Media',
      process: 'Injection Molding',
      rating: 'Promising lead',
      ...
      state: 'IL',
      owner: 'Emily Johnson',
      accountRevenueYTD: 300000,
      accountRevenueLifetime: 1200000,
      upsAccount: 'UPS789012',
      fedexAccount: 'FEDEX789012',
      creditLimit: 50000,
      notes: 'Needs specialized packaging for products.',
    },
    {
      id: 4,
      ...
      email: 'bob.williams@medsupplies.com',
      phone: '(555) 222-3333',
      accountExecutive: 'Christian Lemelin',
      projectManager: 'Stewart Aldrich',
      industry: 'Medical',
      leadSource: 'Email Campaign',
      process: 'Cast Urethane',
      ...
      state: 'NY',
      owner: 'Michael Brown',
      accountRevenueYTD: 900000,
      accountRevenueLifetime: 4000000,
      upsAccount: 'UPS345678',
      fedexAccount: 'FEDEX345678',
      creditLimit: 200000,
      notes: 'High priority client with potential for more services.',
    },
    {
      id: 5,
      ...
      totalSpent: 1003.3,
      avatar: '/images/avatars/5.png',
      registrationDate: '2023-05-30T00:00:00Z',
      firstName: 'Charlie',
      lastName: 'Brown',
      account: 'Automotive Parts',
      email: 'charlie.brown@autoparts.com',
      phone: '(555) 444-5555',
      accountExecutive: 'Sojwal AE',
      projectManager: 'Pratik AE',
      industry: 'Automotive',
      leadSource: 'Trade Show',
      process: 'Sheet Metal',
      ...
      state: 'FL',
      owner: 'Alice Davis',
      accountRevenueYTD: 400000,
      accountRevenueLifetime: 1800000,
      upsAccount: 'UPS987654',
      fedexAccount: 'FEDEX987654',
      creditLimit: 80000,
      notes: 'Looking for partnerships in transportation.',
    },
    {
      id: 6,
      ...
      firstName: 'Diana',
      lastName: 'Prince',
      account: 'Global Shipping',
      email: 'diana.prince@globalshipping.com',
      phone: '(555) 678-9012',
      accountExecutive: 'Ryan Costello',
      projectManager: 'Matt Wendel',
      industry: 'Logistics',
    ...
    },
    {
      ...
      totalSpent: 7936.85,
      avatar: '/images/avatars/7.png',
      registrationDate: '2023-07-25T00:00:00Z',
      firstName: 'Bruce',
      lastName: 'Wayne',
    ...
    },
    {
      ...
      totalSpent: 4150.97,
      avatar: '/images/avatars/8.png',
      registrationDate: '2023-08-10T00:00:00Z',
      firstName: 'Clark',
      lastName: 'Kent',
      ...
      process: '3D Printing',
      rating: 'In progress',
      note: 'Pending decision from management',
      nda: false,
      accountId: 'ACC-33445',
      status: 'Inactive', 
      city: 'Chicago',
    ...
    },
    {
      ...
      totalSpent: 3430.05,
      avatar: '/images/avatars/1.png',
      registrationDate: '2023-09-14T00:00:00Z',
      firstName: 'Peter',
      lastName: 'Parker',
      account: 'Web Solutions',
      email: 'peter.parker@websolutions.com',
      phone: '(555) 888-7777',
      accountExecutive: 'Christian Lemelin',
      projectManager: 'Stewart Aldrich',
      industry: 'Technology',
      leadSource: 'Webinar',
      process: 'CNC Machining',
      rating: 'Needs follow-up',
      note: 'Schedule next meeting',
      nda: true,
      accountId: 'ACC-66778',
      status: 'Active', 
      city: 'San Francisco',
    ...
    },
    {
      ...
      firstName: 'Wade',
      lastName: 'Wilson',
      account: 'Mercenary Services',
      email: 'wade.wilson@mercservices.com',
      phone: '(555) 456-7890',
      accountExecutive: 'Sojwal AE',
      projectManager: 'Matt Wendel',
      ...
      leadSource: 'Social Media',
      process: 'Cast Urethane',
      rating: 'Interesting lead',
      note: 'Consider future collaboration',
      nda: false,
      accountId: 'ACC-99887',
      status: 'Inactive', 
      city: 'Los Angeles',
