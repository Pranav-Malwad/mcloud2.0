...
const CustomerListTable = ({ customerData }) => {
  ...
  const columns = useMemo(
    () => [
          ...
          <div className='flex items-center gap-3'>
            ...
            <div className='flex flex-col items-start'>
              <Typography
                component={Link}
                color='text.primary'
                href={getLocalizedUrl(`/apps/contacts/details/${row.original.customerId}`, locale)}
      ...
      columnHelper.accessor('leadSourceDetails', {
        header: 'Lead Source Details',
        cell: ({ row }) => <Typography>{row.original.leadSourceDetails}</Typography>
      }),
      ...
      columnHelper.accessor('accountId', {
        header: 'Account ID',
        cell: ({ row }) => <Typography>{row.original.accountId}</Typography>
      }),
  ...
  return (
    <>
      {/* <CardCounters entityType='Contacts' counts={contactsCounts}></CardCounters> */}
      <Card className='mt-6'>
