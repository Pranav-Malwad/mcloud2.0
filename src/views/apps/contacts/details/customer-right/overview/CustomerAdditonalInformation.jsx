...
import { Button, TextField, MenuItem, Grid, Typography, Card, InputAdornment } from '@mui/material'
  ...
  return (
    <Card className='p-4'>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={4}>
          <TextField label='Lead Source Details' name='leadSourceDetail' value={formData.leadSourceDetail} onChange={handleChange} disabled={!isEditing} fullWidth size='small' InputLabelProps={{ shrink: true }} />
        </Grid>
        <Grid item xs={12} sm={4}>
