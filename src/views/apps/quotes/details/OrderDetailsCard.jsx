...
<Button variant='outlined' size='small' className='max-sm:is-full'>Edit Quote</Button>
<Button variant='outlined' size='small' className='max-sm:is-full' onClick={handlePlaceOrderClick} >Place Order</Button>
<Button variant='outlined' size='small' className='max-sm:is-full'>Email Quote</Button>
<Button variant='outlined' size='small' className='max-sm:is-full'>Download Quote</Button>
<Button variant='outlined' size='small' className='max-sm:is-full'>Supplier RFQ</Button>
</div>
    </Card>
  )
}
